...
cor (traits$GestLen.d,traits$Body.mass.g,use="complete.obs")
cor (traits$WeanAge.d,traits$Body.mass.g,use="complete.obs")
...
std_traits <- data.frame (Body.mass.g = scale(traits$Body.mass.g),
                          ...
                          GestLen.d = scale(traits$GestLen.d),
                          WeanAge.d = scale(traits$WeanAge.d)
                          )
...
# select 3 traits
std_traits <- std_traits[,c("Body.mass.g", "LitSz","MaxLifepsan")]
...
dir.create("Processed_data_sensitivity_2")
...
save(psignal,
     ...
     combined_data,
     file = here ( "Processed_data_sensitivity_2","image_rodents.RData"))
