...
# -----------------------------------------------------
require(here)
load (here("Output_sensitivity_2", "simulated_FD_BM_rodents.RData"))
...
load(here ( "Processed_data_sensitivity_2","Spatial_covs_data.RData"))

# Create folder to store figures
dir.create (here("Output_sensitivity_2", "Figures"))
...
fig_params_rodents
ggsave(here("Output_sensitivity_2", "Figures", "parameter_estimates_rodents.png"))
...
save (model.ancova.FRic,
      ...
      mod_dat,
      mod_dat_FEve,
      file=here("Output_sensitivity_2", "GLM_test_rodents.RData"))
# end 