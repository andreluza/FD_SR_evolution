...
# load
load (file=here("Output_sensitivity_2", "GLM_test_haemulidae.RData"),envir = env_haemulidae)
load (file=here("Output_sensitivity_2", "GLM_test_labridae.RData"),envir = env_labridae)
load (file=here("Output_sensitivity_2", "GLM_test_rodents.RData"),envir = env_rodents)
...
# plotting
p1_rod<-plot(conditional_effects(env_rodents$model.ancova.FRic_sq,
...
# plotting
p2_rod<-plot(conditional_effects(env_rodents$model.ancova.FEve,
                             method="posterior_epred",
                             re_formula=NA,
                             robust=T,
                             effects = "logSR:Dataset",
...
# plotting
p1_lab<-plot(conditional_effects(env_labridae$model.ancova.FRic_sq,
                             method="posterior_epred",
                             re_formula=NA,
                             robust=T,
                             effects = "logSR:Dataset",
...
# plotting
p2_lab<-plot(conditional_effects(env_labridae$model.ancova.FEve,
                             method="posterior_epred",
                             re_formula=NA,
                             robust=T,
                             effects = "logSR:Dataset",
...
# plotting
p1_hae<-plot(conditional_effects(env_haemulidae$model.ancova.FRic_sq,
                             method="posterior_epred",
                             re_formula=NA,
                             robust=T,
                             effects = "logSR:Dataset",
...
# plotting
p2_hae<-plot(conditional_effects(env_haemulidae$model.ancova.FEve,
                             method="posterior_epred",
                             re_formula=NA,
                             robust=T,
                             effects = "logSR:Dataset",
...
# organize plots
png(here("Output_sensitivity_2","Figures","Fig3.png"), width=19,height=22,units = "cm",res=200)
  grid.arrange(p1_rod+labs(title="Rodents")+theme(axis.title.x = element_blank()), 
               p2_rod+labs(title="")+theme(axis.title.x = element_blank(), legend.position = "none"), 
               p1_lab+labs(title="Wrasses")+theme(axis.title.x = element_blank(), legend.position = "none"),
               p2_lab+labs(title="")+theme(axis.title.x = element_blank(), legend.position = "none"), 
               p1_hae+labs(title="Grunts")+theme(legend.position = "none"),
               p2_hae+labs(title="")+theme(legend.position = "none"), 
...
ggsave(here("Output_sensitivity_2","Figures","Fig4.png"), width=7,height=8)
...
ggsave(here("Output_sensitivity_2","Figures","FigS5.png"), width=7,height=7)
...
ggsave(here("Output_sensitivity_2","Figures","FigS6.png"), width=7,height=7)
