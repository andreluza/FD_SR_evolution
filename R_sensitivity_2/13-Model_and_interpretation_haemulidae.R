...
# ----------------------------------------------------
load (here("Output_sensitivity_2", "simulated_FD_BM_haemulidae.RData"))
load (here("Output_sensitivity_2", "simulated_FD_EB_haemulidae.RData"))
load (here("Output_sensitivity_2", "simulated_FD_OU_haemulidae.RData"))
load (here("Output_sensitivity_2", "empirical_FD_haemulidae.RData"))
load (here("Output_sensitivity_2", "simulated_FD_random_haemulidae.RData"))

# load R data
load(here ( "Processed_data_sensitivity_2","image_haemulidae.RData"))
load(here ( "Processed_data","Spatial_covs_data_reefs.RData"))

# organize params
df_params<- lapply (seq (1,3), function (k){
...
fig_params_fish
ggsave(here("Output_sensitivity_2", "Figures", "parameter_estimates_haemulidae.png"))
...
#load(here("Output_sensitivity_2", "GLM_test_haemulidae.RData"))
...
save (model.ancova.FRic,
      ...
      mod_dat,
      mod_dat_FEve,
      file=here("Output_sensitivity_2", "GLM_test_haemulidae.RData"))
