...
Upham et al. 2016.  
\|– *Processed_data*: Basic data to fit models (“image*.RData”) for each
group. Data of environmental and historical covariates after extraction
to survey sites are available in this folder. Data of analyses shown in
the main text.  
\|– *Processed_data_sensitivity*: Basic data to fit models
(”image*.RData”) for each group. Analyses with seven traits. Data of
analyses shown in the supporting information.  
\|– *Processed_data_sensitivity_2*: Basic data to fit models
(“image*.RData”) for each group. Analyses with seven traits. Data of
analyses shown in the supporting information.  
...
Analyses with three traits (main text);  
\|– *Output_sensitivity_1*: files in format ’RData’ with parameters of
macroevolutionary models fitted to the data (sufix ’simulated*.RData’)
and Bayesian linear models fitted to FRic and FEve data (sufix ”GLM”).
Analyses with seven traits (supporting information);  
\|– *Output_sensitivity_2*: files in format ‘RData’ with parameters of
macroevolutionary models fitted to the data (sufix ’simulated*.RData’)
and Bayesian linear models fitted to FRic and FEve data (sufix”GLM”).
Analyses with three traits (supporting information);  
...
to 15, depicting different steps of analysis. Analyses with five
traits.  
\|– *R_sensitivity_1*: R scripts used in the analyzes. The codes are
numbered from 1 to 15, depicting different steps of analysis. Analyses
with seven traits.  
\|– *R_sensitivity_21*: R scripts used in the analyzes. The codes are
numbered from 1 to 15, depicting different steps of analysis. Analyses
with three traits.  
...
#### This paper was produced using the following software and associated packages: 
    ...
    ##  [1] worrms_0.4.3            terra_1.8-86            sf_1.1-2               
    ...
    ## [28] nlme_3.1-168            vegan_2.7-2             permute_0.9-10         
    ...
    ##   [7] farver_2.1.2            rmarkdown_2.32          fs_1.6.6               
    ...
    ##  [19] cachem_1.1.0            igraph_2.3.3            lifecycle_1.0.5        
    ...
    ##  [40] rngtools_1.5.2          withr_3.0.3             doParallel_1.0.17      
    ##  [43] S7_0.2.1                backports_1.5.0         optimParallel_1.0-3    
    ##  [46] DBI_1.2.3               ggforce_0.5.0           MASS_7.3-65            
    ##  [49] rappdirs_0.3.4          classInt_0.4-11         scatterplot3d_0.3-45   
    ##  [52] loo_2.9.0               units_1.0-0             tools_4.5.2            
    ##  [55] ranger_0.17.0           otel_0.2.0              zip_3.0.2              
    ##  [58] glue_1.8.0              quadprog_1.5-8          grid_4.5.2             
    ##  [61] checkmate_2.3.3         cluster_2.1.8.2         generics_0.1.4         
    ##  [64] gtable_0.3.6            class_7.3-23            tidyr_1.3.2            
    ##  [67] foreach_1.5.2           pillar_1.11.1           ggdist_3.3.3           
    ##  [70] stringr_1.6.0           yulab.utils_0.2.3       spam_2.11-4            
    ##  [73] posterior_1.6.1         splines_4.5.2           tweenr_2.0.3           
    ##  [76] dplyr_1.1.4             lattice_0.22-7          tidyselect_1.2.1       
    ##  [79] knitr_1.52              arrayhelpers_1.1-0      xfun_0.60              
    ##  [82] expm_1.0-1              bridgesampling_1.2-1    matrixStats_1.5.0      
    ##  [85] stringi_1.8.7           ggfun_0.2.0             yaml_2.3.12            
    ##  [88] evaluate_1.0.5          codetools_0.2-20        tibble_3.3.0           
    ##  [91] cli_3.6.5               RcppParallel_5.1.11-1   xtable_1.8-8           
    ##  [94] pbmcapply_1.5.1         Rdpack_2.6.6            processx_3.8.6         
    ...
    ## [112] fastmatch_1.1-8         mnormt_2.1.2
