...
# select haemulidae spp in the phylogeny
...
# load fish data
load(here ( "Processed_data_sensitivity","image_haemulidae.RData"))
...
# save
save (empirical_FD,
      file= here("Output_sensitivity_1", 
...
simul<-lapply (seq(1,length(match_data)), function (i) 
  ...
  mvSIM(match_data[[i]]$phy,
        ...
        param=list(sigma=diag (c(simul_param_BM[[i]]$Body_size$opt$sigsq,
                                 ...
                                 simul_param_BM[[i]]$Depth_range$opt$sigsq,
                                 simul_param_BM[[i]]$Geographic_range_index$opt$sigsq)),
                   theta=theta,
                   ntraits=ntraits,
...
save (simul_param_BM,
      simulated_FD,
      file= here("Output_sensitivity_1", 
                 "simulated_FD_BM_haemulidae.RData"))
  ...
  tryCatch(
    mvSIM(match_data[[i]]$phy,
          ...
          param=list(sigma=diag (c(simul_param_EB[[i]]$Body_size$opt$sigsq,
                                 ...
                                 simul_param_EB[[i]]$Depth_range$opt$sigsq,
                                 simul_param_EB[[i]]$Geographic_range_index$opt$sigsq)), 
                     beta=diag (c(simul_param_EB[[i]]$Body_size$opt$a,
                                 ...
                                 simul_param_EB[[i]]$Depth_range$opt$a,
                                 simul_param_EB[[i]]$Geographic_range_index$opt$a
                                  )),
                     theta=theta,
                     ntraits=ntraits,
                     names_traits=c("Trait 1",
...
save (simul_param_EB,
      simulated_FD_EB,
      file= here("Output_sensitivity_1", 
                 "simulated_FD_EB_haemulidae.RData"))
  ...
  tryCatch(
    mvSIM(match_data[[i]]$phy,
          ...
          param=list(sigma=diag (c(simul_param_OU[[i]]$Body_size$opt$sigsq,
                                 ...
                                 simul_param_OU[[i]]$Depth_range$opt$sigsq,
                                 simul_param_OU[[i]]$Geographic_range_index$opt$sigsq)), 
                     alpha = diag (c(simul_param_OU[[i]]$Body_size$opt$alpha,
                                 ...
                                 simul_param_OU[[i]]$Depth_range$opt$alpha,
                                 simul_param_OU[[i]]$Geographic_range_index$opt$alpha)),
                     theta=theta,
                     ntraits=ntraits,
                     names_traits=c("Trait 1",
                                    "Trait 2",
...
save (simul_param_OU,
      simulated_FD_OU,
      file= here("Output_sensitivity_1", "simulated_FD_OU_haemulidae.RData"))
