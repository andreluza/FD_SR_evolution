...
# load
load (file=here("Output_sensitivity_1", "GLM_test_haemulidae.RData"),envir = env_haemulidae)
load (file=here("Output_sensitivity_1", "GLM_test_labridae.RData"),envir = env_labridae)
load (file=here("Output_sensitivity_1", "GLM_test_rodents.RData"),envir = env_rodents)
...
# organize plots
png(here("Output_sensitivity_1","Figures","Fig3.png"), width=19,height=22,units = "cm",res=200)
...
ggsave(here("Output_sensitivity_1","Figures","Fig4.png"), width=7,height=8)
...
ggsave(here("","Figures","FigS5.png"), width=7,height=7)
...
ggsave(here("","Figures","FigS6.png"), width=7,height=7)
