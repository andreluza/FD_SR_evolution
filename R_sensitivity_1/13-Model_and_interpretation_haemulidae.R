...
# ----------------------------------------------------
load (here("Output_sensitivity_1", "simulated_FD_BM_haemulidae.RData"))
load (here("Output_sensitivity_1", "simulated_FD_EB_haemulidae.RData"))
load (here("Output_sensitivity_1", "simulated_FD_OU_haemulidae.RData"))
load (here("Output_sensitivity_1", "empirical_FD_haemulidae.RData"))
load (here("Output_sensitivity_1", "simulated_FD_random_haemulidae.RData"))
...
fig_params_fish
ggsave(here("Output_sensitivity_1", "Figures", "parameter_estimates_haemulidae.png"),width = 7,height = 12)
...
#load(here("Output_sensitivity_1", "GLM_test_haemulidae.RData"))


##---------------------------------------------------------

# run model (ancova)
model.ancova.FRic <- brm (brmsformula(log(FRic) ~ (logSR*Dataset)+logEffort,
                          sigma ~ logSR),
                          data=df_analyzes,
...
df_analyzes$Residuals_FRic <- residuals(model.ancova.FRic_sq)[,"Estimate"]
...
save (model.ancova.FRic,
      ...
      mod_dat,
      mod_dat_FEve,
      file=here("Output_sensitivity_1", "GLM_test_haemulidae.RData"))
