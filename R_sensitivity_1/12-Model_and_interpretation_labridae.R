...
# ---------------------------------------------------------------------
# fish - Labridae
load (here("Output_sensitivity_1", "simulated_FD_BM_labridae.RData"))
load (here("Output_sensitivity_1", "simulated_FD_EB_labridae.RData"))
load (here("Output_sensitivity_1", "simulated_FD_OU_labridae.RData"))
load (here("Output_sensitivity_1", "empirical_FD_labridae.RData"))
#load (here("Output_sensitivity_1", "simulated_FD_random_labridae.RData"))

# load R data
load(here ( "Processed_data_sensitivity","image_labridae.RData"))
...
fig_params_fish
ggsave(here("Output_sensitivity_1", "Figures", "parameter_estimates_labridae.png"),width = 7,height = 12)
...
save (model.ancova.FRic,
      ...
      mod_dat,
      mod_dat_FEve,
      file=here("Output_sensitivity_1", "GLM_test_labridae.RData"))
#load(here("Output_sensitivity_1", "GLM_test_labridae.RData"))
# end
